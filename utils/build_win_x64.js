...
const build = async () => {
  ...
  await rcedit(`./pkg-cache/v3.2/built-v${specificNodeVersion}-win-x64`, {
    ...
    "version-string": {
      ...
      ProductName: "EvntBoard: Module Midi", // "Node.js"
      FileDescription: "EvntBoard: Module Midi", //  "Node.js: Server-side JavaScript"
      FileVersion: version, // NODE_EXE_VERSION
      ProductVersion: version, // NODE_EXE_VERSION
      OriginalFilename: "module-midi.exe", // "node.exe"
      InternalName: "module-midi", // "node"
